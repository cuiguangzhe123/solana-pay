 ...
 */
var FindTransactionSignatureError = /** @class */ (function (_super) {
    __extends(FindTransactionSignatureError, _super);
    function FindTransactionSignatureError() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = 'FindTransactionSignatureError';
        return _this;
    }
    return FindTransactionSignatureError;
}(Error));
...
function findTransactionSignature(connection, reference, options, finality) {
    return __awaiter(this, void 0, void 0, function () {
        var signatures, length, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.getSignaturesForAddress(reference, options, finality)];
                case 1:
                    signatures = _a.sent();
                    ...
                    if (length < ((options === null || options === void 0 ? void 0 : options.limit) || 1000))
                        return [2 /*return*/, signatures[length - 1]];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, findTransactionSignature(connection, reference, options, finality)];
                case 3: 
                // In the unlikely event that more signatures than the limit are found, recursively find the oldest one.
                return [2 /*return*/, _a.sent()];
                case 4:
                    error_1 = _a.sent();
                    if (error_1 instanceof FindTransactionSignatureError)
                        return [2 /*return*/, signatures[length - 1]];
                    throw error_1;
