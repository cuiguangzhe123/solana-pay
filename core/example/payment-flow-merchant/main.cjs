...
var establishConnection_1 = require("./establishConnection");
var simulateCheckout_1 = require("./simulateCheckout");
var simulateWalletInteraction_1 = require("./simulateWalletInteraction");
function main() {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, establishConnection_1.establishConnection)()];
                case 1:
                    connection = _b.sent();
                    /**
